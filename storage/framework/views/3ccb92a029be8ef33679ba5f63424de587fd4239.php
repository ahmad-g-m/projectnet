                        ...
                        <?php $c=0; ?>
                                ...
                                ?>
                                                        <div class="col-sm-6 border bg-dark mb-2  postbox-left">
                                                            <a href="<?php echo e(url('machines/'.$type.'/carpage/'.$id)); ?>"><img class="rounded post-img" style="max-height: 200px;" src="data:image/jpeg;base64,<?php echo e(base64_encode($conte)); ?>" width="100%" height="200px" ></a>
                                                            <p class="post-text"><?php echo e($brand .' '. $name . ' ' . $model); ?></p>
                                                        </div>
                                ...
                                <!-- <div class="col-sm-6 border bg-dark mb-2  postbox-left">
                                    <a href="<?php echo e(url('machines/sedanscars/carpage/'.$id)); ?>"><img class="rounded post-img" style="max-height: 200px;" src="data:image/jpeg;base64,<?php echo e(base64_encode($conte)); ?>" width="100%" height="200px" ></a>
...
</html><?php /**PATH E:\wamp64\www\projectnet\projectnet\resources\views/cars/category.blade.php ENDPATH**/ ?>