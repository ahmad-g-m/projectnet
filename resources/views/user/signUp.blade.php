	...
	<header class="masterHeader text-center text-white">
		<nav class="navbar navbar-light">
			<div class="container">
				...
				<a href="{{route('loginadmin')}}" class="btn btn-primary">Sign In</a>
			</div>
		</nav>
			...
			<div class="row d-flex flex-column justify-content-center align-items-center">
				<div class="col-3 col-lg-2 d-flex justify-content-between align-items-center mb-5 mt-4">
					<a href="https://www.twitter.com">
						<img src="data:image/svg+xml;base64,{{ base64_encode($conte1)}}" style="max-width: 20px;" alt="twitter" class="sizeContact">
					</a>
					<a href="https://www.instagram.com/">
						<img src="data:image/svg+xml;base64,{{ base64_encode($conte2)}}" style="max-width: 20px;" alt="instagram" class="sizeContact">
					</a>
					<a href="https://www.telegram.com">
						<img src="data:image/svg+xml;base64,{{ base64_encode($conte3)}}" style="max-width: 20px;" alt="telegram" class="sizeContact">
					</a>
				</div>
			</div>
		</div>
