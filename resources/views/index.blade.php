                        ...
                        <div class="col-sm-12 bg-light ">
                            ...
                            @foreach($carposts as $car)
                                ...
                                <div class="col-sm-6 border bg-dark mb-2  postbox-left">
                                    <a href="{{url('machines/'.$type.'/carpage/'.$car->id)}}"><img class="rounded post-img" style="max-height: 200px;" src="data:image/jpeg;base64,{{ base64_encode($conte)}}" width="100%" height="200px" ></a>
